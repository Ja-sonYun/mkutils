...
@test "args: handles multiple arguments" {
    ...
    assert_success
    assert_output "ARGS: arg1 arg2 arg3"
}
...
@test "args: handles long argument" {
    ...
    assert_success
    assert_output "ARGS: --very-long-argument-name"
}
